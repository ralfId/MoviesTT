...
using CoreGraphics;
using Foundation;
using MoviesTT.iOS.Renders;
using MoviesTT.Renders;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(EntryRender), typeof(EntryRenderIOS))]
namespace MoviesTT.iOS.Renders
{
    public class EntryRenderIOS : EntryRenderer
    {
        ...
        {
            if (e.PropertyName == EntryRender.PaddingProperty.PropertyName)
            {
                UpdatePadding();
            }
